...
@section('content')
        ...
        <form action="" method="post" id="formdata">
            ...
            <div class="row">
                <div class="col text-center">
                    <h3>Listado de Cotizaciones de Refacciones</h3>
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-8">
                    <a href="{{url('/i_cotizacion')}}" class="btn btn-info">Registrar</a>
                </div>
            ...
            <div class="row">
                <div class="col-md-2"></div>
                <div class="col-md-8">
                    <table id="list_cotizar" class="table table-striped table-bordered" border="0">
                        ...
                        <tbody class="">
                            @foreach ($list_cotizaciones as $cotizaciones)
                            <tr>
                                <td>{{$cotizaciones->id}}</td>
                                <td>{{$cotizaciones->id_vehiculo}}</td>
                                <td>{{$cotizaciones->marca}}</td>
                                <td>{{$cotizaciones->submarca}}</td>
                                <td>{{$cotizaciones->color}}</td>
    ...
    <script src="{{ asset('js/compras/cotizar/l_cotizar.js') }}"></script>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="{{route('d_costrefacciones', 'delete_item')}}" method="post" id="modal_delete">
                            @csrf
