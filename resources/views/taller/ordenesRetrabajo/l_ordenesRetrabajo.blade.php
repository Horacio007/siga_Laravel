...
@section('content')
        ...
        <form action="" method="post" id="formdata">
            ...
            <div class="row">
                <div class="col text-center">
                    <h3>Listado de Ordenes de Retrabajo</h3>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col">
                    <a href="{{url('/i_ordenesrt')}}" class="btn btn-info">Registrar</a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col">
                    <table id="list_ordenesrt" class="table table-striped table-bordered" border="0">
    ...
    <script src="{{ asset('/js/taller/ordenesRetrabajo/l_ordenesRetrabajo.js') }}"></script>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="{{route('d_ordenesrt', 'delete_item')}}" method="post" id="modal_delete">
                            @csrf
                            <label for="">Orden de Retrabajo</label>
