$(document).ready(function(){
    ...
    $('#list_cotizar').DataTable({
        dom: 'Blfrtip',
        buttons: [{
                extend: 'excelHtml5',
                messageTop: 'Cotizaciones de Refacciones',
                text: "Excel",
                title: "Listado de Costeo de Refacciones",
            },
            {
                /*'csvHtml5',*/
                extend: 'csvHtml5',
                text: "CSV",
                title: "Listado de Costeo de Refacciones",
                messageTop: 'Listado de Costeo de Refacciones',
            },
            {
                extend: 'pdfHtml5',
                title: 'Listado de Costeo de Refacciones'
    ...
    $("#list_cotizar tbody").on('click', '.delete', function(){
