...
@section('content')
    ...
    <div class="container-fluid">
        <form action="" method="post" id="formdata">
            ...
            <div class="row">
                <div class="col">
                    <a href="{{url('/i_ordenest')}}" class="btn btn-info">Registrar</a>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col">
                    <table id="list_ordenest" class="table table-striped table-bordered" border="0">
                        ...
                        <tbody class="">
                            ...
                            <tr>
                                ...
                                <td>{{$orden->nombre}}</td>
                                <td>
                                    <a href="{{ route('u_ordenest', $orden->id)}}" class="btn btn-primary" title="Editar"><i class="fa fa-edit"></i></a>
                                    <a href="{{ route('create_pdfot', $orden->id) }}" class="btn btn-info" target='_blank' title="PDF"><i class="fa fa-file-pdf"></i></a>
    ...
    <script src="{{ asset('/js/taller/ordenesTrabajo/l_ordenesTrabajo.js') }}"></script>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="{{route('d_ordenest', 'delete_item')}}" method="post" id="modal_delete">
                            @csrf
