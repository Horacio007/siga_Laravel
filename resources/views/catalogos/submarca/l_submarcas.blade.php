                    ...
                    <table id="list_submarcas" class="table table-striped table-bordered" border="0">
                        ...
                        <tbody class="">
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('u_submarca', $submarcav->id)}}" class="btn btn-primary" title="Editar"><i class="fa fa-edit"></i></a> 
                                <a href="#" class="btn btn-danger delete" data-toggle='modal' data-target='#modalD' item_id="{{$submarcav->id}}" title="Eliminar"><i class="fa fa-trash"></i></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
