...
@section('content')
        ...
        <form action="" method="post" id="formdata">
            ...
            <div class="row">
                <div class="col text-center">
                    <h3>Listado de Estatus Refacciones</h3>
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="{{url('/i_estatusref')}}" class="btn btn-info">Registrar</a>
                </div>
                <div class="col-md-3"></div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-3"></div>
                <div class="col-md-6">
                    <table id="list_almacenref" class="table table-striped table-bordered" border="0">
                        ...
                        <tbody class="">
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('u_estatusref', $refaccion->id)}}" class="btn btn-primary" title="Editar"><i class="fa fa-edit"></i></a> 
    ...
    <script src="{{ asset('js/catalogos/estatusRefacciones/estatusRefacciones.js') }}"></script>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="{{route('d_estatusref', 'delete_item')}}" method="post" id="modal_delete">
                            @csrf
