...
@section('content')
        ...
        <form action="" method="post" id="formdata">
            ...
            <div class="row">
                <div class="col text-center">
                    <h3>Listado de Estatus de Facturas</h3>
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="{{url('/i_estatusF')}}" class="btn btn-info">Registrar</a>
                </div>
                <div class="col-md-3"></div>
            </div>
            <br>
                    ...
                    <table id="list_areas" class="table table-striped table-bordered" border="0">
                        ...
                        <tbody class="">
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('u_estatusF', $estatus->id)}}" class="btn btn-primary" title="Editar"><i class="fa fa-edit"></i></a> 
    ...
    <script src="{{ asset('/js/catalogos/facturas/facturas.js') }}"></script>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="{{route('d_estatusF', 'delete_item')}}" method="post" id="modal_delete">
                            @csrf
