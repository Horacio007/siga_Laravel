$(document).ready(function(){
    ...
    $('#list_audlimpieza').DataTable({
        dom: 'Blfrtip',
        buttons: [{
                extend: 'excelHtml5',
                messageTop: 'Areas',
                text: "Excel",
                title: "Listado de Auditorias de Limpieza",
            },
            {
                /*'csvHtml5',*/
                extend: 'csvHtml5',
                text: "CSV",
                title: "Listado de Auditorias de Limpieza",
                messageTop: 'Listado de Auditorias de Limpieza',
            },
            {
                extend: 'pdfHtml5',
                title: 'Listado de Auditorias de Limpieza'
    ...
    $("#list_audlimpieza tbody tr").on('click', '.delete', function(){
