...
@section('content')
        ...
        <form action="" enctype="multipart/form-data" method="post" id="formdata">
            <div class="row">
                <div class="col text-center">
                    <h3>Cambiar Estatus del Vehiculo</h3>
                </div>
            </div>
            <br>
            <div class="row">
                        ...
                        <tbody class="text-capitalize">
                            @foreach ($vehiculos as $vehiculo)
                                <tr>
                                    ...
                                    <td><a href="{{ route('u_cambiarEstatus', $vehiculo->id) }}" class="btn btn-info" title="Editar"><i class="fa fa-edit"></i></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
    ...
    <script src="{{ asset('/js/entrega/estatus/l_cambiarEstatus.js') }}"></script>
@endsection